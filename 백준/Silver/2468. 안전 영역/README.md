...
아무 지역도 물에 잠기지 않을 수도 있다. -> 이 부분을 잘 해석하지 못해 해멨는데, 높이 0부터 반복문을 돌리면 된다.
최대 영역 수를 구해야 하므로 graph 방문 여부를 반복문마다 삭제해야 하는데 그걸 까먹어서 해맸다.

### 성능 요약

메모리: 32524 KB, 시간: 2020 ms
